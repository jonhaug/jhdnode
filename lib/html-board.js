...
var prefix =
    ...
    "<style>\n" +
    "  html   { font-family: ariel, sans-serif;}\n" +
    "  td { border: 1px solid #c9c9c9;}\n" +
    "  td.normal { min-width: 50px; min-height: 50px; max-width: 50px; max-height: 50px; border: 1px solid #c9c9c9; padding: 5px 7px; \n" +
    "              vertical-align: middle; text-align: center; background-color: #f9badd; }\n" +
    "  td.small { width: 10px; border: 0px solid #c9c9c9; padding: 0px;vertical-aligin: middle; text-align: center;\n" +
    "             }\n" +
    "  td.tdblock { margin: 0px; padding: 0px; border: 2px solid blue; width: 178px; height: 178px; }\n" +
    ...
    "          background-color: green; table-layout: fixed; }\n" +
    "  table.tblock { table-layout: fixed; margin: 0px; font-size: xx-large;empty-cells: show; background-color: red;}\n" +
    "  table.small { width: 44px; height: 44px; border: 0px solid orange; padding: 0px; table-layout: fixed;\n" +
    "                margin: 0px; font-size: xx-small;empty-cells: show; background-color: yellow; }\n" +
    "</style></head>\n" +
    "<body>\n";
